...
public class ListComponent<E> extends JList<E> {
    ...
    public ListComponent(DefaultListModel<E> listModel) {
        ...
        setFixedCellHeight(35);  // Fixed height for each cell
    ...
    private static class CustomListCellRenderer extends DefaultListCellRenderer {
        ...
        public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
            ...
            if (!isSelected) {
                ...
                label.setBackground(new Color(0, 111, 238)); // Blue when selected
            ...
            label.setBorder(BorderFactory.createEmptyBorder(10, 15, 10, 15)); // Padding for the list cell
